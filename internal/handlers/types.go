...
// SharedProjectTrack is a typed replacement for map[string]interface{} in project share responses.
type SharedProjectTrack struct {
	ID                           int64      `json:"id"`
	UserID                       int64      `json:"user_id"`
	ProjectID                    int64      `json:"project_id"`
	PublicID                     string     `json:"public_id"`
	...
	ActiveVersionDurationSeconds *float64   `json:"active_version_duration_seconds"`
	Waveform                     *string    `json:"waveform"`
	LossyTranscodingStatus       *string    `json:"lossy_transcoding_status"`
...
type ValidateShareResponse struct {
	...
	Tracks           []SharedProjectTrack `json:"tracks,omitempty"`
...
type ShareTokenResponse struct {
	...
	CurrentAccessCount int64      `json:"current_access_count,omitempty"`
	AllowEditing       bool       `json:"allow_editing"`
	AllowDownloads     bool       `json:"allow_downloads"`
